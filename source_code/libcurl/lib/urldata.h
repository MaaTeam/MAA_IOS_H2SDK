...
struct connectdata {
  ...
  struct Curl_maa maa;/* MAA data, save it here for connection reuse */
...
struct SessionHandle {
  ...
  bool maa_enable;        /* MAA flag */
  bool maa_https_switch;  /* MAA flag: switch http to https */
  struct Curl_maa maa;    /* MAA data for access log recoding.
                             When invoking Curl_maa_on_url_complete,
                             connectdata has been detached from SessionHandle,
                             so we copy it from connectdata before detaching */
  struct Names dns;
